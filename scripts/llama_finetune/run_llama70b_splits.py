...
DEFAULT_OLLAMA_MODEL = os.getenv("OLLAMA_MODEL", "llama3.1:70b")
...
DEFAULT_TOKENIZER = "meta-llama/Llama-3.1-70B-Instruct"
...
def process_split(
    ...
    run_id = f"llama70b_split{run_info.split_id:02d}_{run_stamp}"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run Llama 70B on test splits")
    parser.add_argument("--runs-dir", default="runs/splits")
    parser.add_argument("--output-root", default="runs/llama70b_splits")
